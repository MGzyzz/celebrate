...
export const i18n = {
  ru: {
    ...
    type_common: "Общий", type_alcohol: "Алкоголь", type_individual: "Индивидуальный", type_group: "Для группы", cat_food: "Еда", cat_drinks: "Напитки", cat_decor: "Декор", cat_music: "Музыка", cat_other: "Другое",
  ...
  kk: {
    ...
    type_common: "Жалпы", type_alcohol: "Алкоголь", type_individual: "Жеке", type_group: "Топқа", cat_food: "Тамақ", cat_drinks: "Сусындар", cat_decor: "Декор", cat_music: "Музыка", cat_other: "Басқа",
